...
class RecommendDataSource(var retrofitClient: RetrofitClient) : PageKeyedDataSource<Int, Results>() {
    ...
    override fun loadInitial(
        ...
        GlobalScope.launch(Dispatchers.IO) {
            retrofitClient.getAPI(ApiEndPoints::class.java).getRecommendations(movie_id!!, FIRST_PAGE)
    ...
    override fun loadBefore(params: LoadParams<Int>, callback: LoadCallback<Int, Results>) {
        ...
        GlobalScope.launch(Dispatchers.IO) {
            retrofitClient.getAPI(ApiEndPoints::class.java).getRecommendations(movie_id!!, params.key)
                    .enqueue(object : Callback<Movies> {
                        override fun onResponse(call: Call<Movies>, response: Response<Movies>) {
                            if (response.isSuccessful) {
